...
try {
  ...
  const baseRuntime = {
    ...
    systems: [{
      ...
      availabilityTier: "tier-3-standard", userCount: 1, regions: ["us-east-1"],
    ...
    assets: [{
      ...
      criticalityFactors: {
        confidentiality: { score: 2, reason: "test" }, integrity: { score: 2, reason: "test" },
        availability: { score: 2, reason: "test" }, regulatory: { score: 2, reason: "test" },
        businessDependency: { score: 2, reason: "test" },
      },
