...
export const ASSETS: Asset[] = [
  ...
  },
  {
    ...
    code: "ECS",
    criticalityFactors: {
      confidentiality: { score: 80, reason: "Holds customer prompts and completions in memory while orchestrating retrieval, model, and tool calls for every agent turn" },
      integrity: { score: 85, reason: "A tampered or compromised container could manipulate agent decisions or returned outputs at scale" },
      availability: { score: 88, reason: "Core orchestration path — an outage takes every AI feature down" },
      regulatory: { score: 80, reason: "Processes Restricted-tier customer data as part of the agent loop" },
      businessDependency: { score: 92, reason: "The orchestration compute driving the product's core AI capability — every retrieval, model, and tool call originates here" },
    },
  ...
  },
  {
    id: "AST-003-09",
    systemId: "SYS-003",
    name: "Partner Integration Delivery",
    type: "AWS API Gateway",
