// Hand-authored, policy-ready control statements that consolidate a parent SCF
// control with its sub-controls (dropped from the app's data when we filtered
// to top-level-only controls) into one business-facing control. Only written
// for controls that have been explicitly reviewed — everything else falls back
// to the raw SCF description in the drawer.
export const CONSOLIDATED_CONTROLS = {
  "AST-01": {
    statement:
    ...
    sourceControls: ["AST-01", "AST-01.1", "AST-01.2", "AST-01.3", "AST-01.4", "AST-01.5"],
  },
  ...
  "PRM-01": {
    ...
    sourceControls: ["PRM-01", "PRM-01.1", "PRM-01.2"],
  },

  "PRM-02": {
    statement:
      "ACME's capital planning and investment process explicitly accounts for the resources needed to operate the Security, Compliance & Resilience Program (SCRP), with any funding exceptions formally documented and resource priorities adjusted as risks and threats evolve.",
    requirements: [
    ...
    sourceControls: ["PRM-02", "PRM-02.1"],
  },
  ...
  "OPS-01": {
    ...
    sourceControls: ["OPS-01", "OPS-01.1"],
  },
  ...
  "THR-03": {
    ...
    sourceControls: ["THR-03", "THR-03.1"],
  },

  "THR-06": {
    statement:
      "ACME operates a Vulnerability Disclosure Program (VDP) that provides the public and independent researchers a clear, accessible channel to report discovered or suspected vulnerabilities in ACME's technology assets, applications, and services.",
    requirements: [
    ...
    sourceControls: ["THR-06", "THR-06.1"],
  },
  ...
  "WEB-01": {
    ...
    sourceControls: ["WEB-01", "WEB-01.1"],
  },
  ...
  "AAT-01": {
    ...
    sourceControls: ["AAT-01", "AAT-01.1", "AAT-01.2", "AAT-01.3", "AAT-01.4"],
  },
  ...
  "AAT-11": {
    ...
    sourceControls: ["AAT-11", "AAT-11.1", "AAT-11.2", "AAT-11.3", "AAT-11.4"],
  },
  ...
  "AAT-13": {
    ...
    sourceControls: ["AAT-13", "AAT-13.1"],
  },
  ...
  "CHG-02": {
    ...
    sourceControls: ["CHG-02", "CHG-02.1", "CHG-02.2", "CHG-02.3", "CHG-02.4", "CHG-02.5"],
  },

  "CHG-04": {
    statement:
      "ACME restricts the ability to make configuration changes to authorized individuals through enforced access controls, signed components, dual authorization for critical changes, and after-the-fact review of change logs.",
    requirements: [
    ...
    sourceControls: ["CHG-04", "CHG-04.1", "CHG-04.2", "CHG-04.3", "CHG-04.4", "CHG-04.5"],
  },

  "CHG-06": {
    statement:
      "ACME verifies that security, compliance, and resilience controls continue to operate as designed after every implemented change, and reports verification results to organizational management.",
    requirements: [
    ...
    sourceControls: ["CHG-06", "CHG-06.1"],
  },
  ...
  "CLD-01": {
    ...
    sourceControls: ["CLD-01", "CLD-01.1", "CLD-01.2"],
  },
  ...
  "CLD-06": {
    ...
    sourceControls: ["CLD-06", "CLD-06.1", "CLD-06.2", "CLD-06.3", "CLD-06.4"],
  },
  ...
  "CPL-01": {
    ...
    sourceControls: ["CPL-01", "CPL-01.1", "CPL-01.2", "CPL-01.3", "CPL-01.4", "CPL-01.5", "CPL-01.6", "CPL-01.7", "CPL-01.8"],
  },

  "CPL-02": {
    statement:
      "ACME operates an independent controls oversight function — including an internal audit capability — that reports to executive leadership, conducts periodic audits of security, compliance, and resilience controls, and drives corrective action on findings of non-conformity.",
    requirements: [
    ...
    sourceControls: ["CPL-02", "CPL-02.1", "CPL-02.2", "CPL-02.3"],
  },
  ...
  "CPL-03": {
    ...
    sourceControls: ["CPL-03", "CPL-03.1", "CPL-03.2", "CPL-03.3", "CPL-03.4", "CPL-03.5", "CPL-03.6", "CPL-03.7"],
  },
  ...
  "MNT-02": {
    ...
    sourceControls: ["MNT-02", "MNT-02.1"],
  },

  "MNT-03": {
    statement:
      "ACME obtains maintenance support and spare parts for critical technology assets within a defined Recovery Time Objective, combining preventive and predictive maintenance practices with automated data transfer to a computerized maintenance management system.",
    requirements: [
    ...
    sourceControls: ["MNT-03", "MNT-03.1", "MNT-03.2", "MNT-03.3"],
  },

  "MNT-04": {
    statement:
      "ACME controls and monitors the use of system maintenance tools — inspecting tools and media brought on-site, restricting tool use to authorized personnel, and preventing unauthorized removal of equipment under maintenance.",
    requirements: [
    ...
    sourceControls: ["MNT-04", "MNT-04.1", "MNT-04.2", "MNT-04.3", "MNT-04.4"],
  },
  ...
  "MNT-05": {
    ...
    sourceControls: ["MNT-05", "MNT-05.1", "MNT-05.2", "MNT-05.3", "MNT-05.4", "MNT-05.5", "MNT-05.6", "MNT-05.7"],
  },
  ...
  "SEA-01": {
    ...
    sourceControls: ["SEA-01", "SEA-01.1", "SEA-01.2", "SEA-01.3"],
  },

  "SEA-02": {
    statement:
      "ACME maintains an enterprise architecture aligned with industry-recognized practices and security, compliance, and resilience principles, using standardized terminology, deliberate outsourcing decisions, and ongoing technical debt review to manage organizational risk.",
    requirements: [
    ...
    sourceControls: ["SEA-02", "SEA-02.1", "SEA-02.2", "SEA-02.3"],
  },

  "SEA-03": {
    statement:
      "ACME implements security as a layered, defense-in-depth architecture that minimizes interaction between layers and separates system and application functionality to contain the impact of any single control failure.",
    requirements: [
    ...
    sourceControls: ["SEA-03", "SEA-03.1", "SEA-03.2"],
  },

  "SEA-04": {
    statement:
      "ACME isolates execution domains for processes, threads, and system-privileged services so that a compromise or failure in one does not directly compromise another, with security functions separated from non-security functions at the hardware level where feasible.",
    requirements: [
    ...
    sourceControls: ["SEA-04", "SEA-04.1", "SEA-04.2", "SEA-04.3", "SEA-04.4"],
  },

  "SEA-07": {
    statement:
      "ACME analyzes Mean Time to Failure for system components and manages technology lifecycles so that systems fail to a known, secure state and follow defined fail-safe procedures when failure conditions occur.",
    requirements: [
    ...
    sourceControls: ["SEA-07", "SEA-07.1", "SEA-07.2", "SEA-07.3"],
  },

  "SEA-14": {
    statement:
      "ACME employs concealment and misdirection techniques — including automated randomization of operational patterns and processing/storage locations — to confuse and mislead adversaries attempting to target its technology assets, applications, and services.",
    requirements: [
    ...
    sourceControls: ["SEA-14", "SEA-14.1", "SEA-14.2"],
  },

  "SAT-01": {
    statement:
      "ACME builds and maintains a security-minded workforce through a formal development and awareness program that is periodically reviewed to stay current with policy changes, role changes, evolving threats, and new technology.",
    requirements: [
    ...
    sourceControls: ["SAT-01", "SAT-01.1"],
  },
  ...
  "SAT-02": {
    ...
    sourceControls: ["SAT-02", "SAT-02.1", "SAT-02.2"],
  },

  "SAT-03": {
    statement:
      "ACME requires role-based security training before granting system access, after significant system changes, and annually thereafter — covering practical exercises, malware and social-engineering indicators, sensitive data handling, vendor-specific technology, privileged-user responsibilities, the current threat landscape, and continuing education for security and DevOps personnel.",
    requirements: [
    ...
    sourceControls: ["SAT-03", "SAT-03.1", "SAT-03.2", "SAT-03.3", "SAT-03.4", "SAT-03.5", "SAT-03.6", "SAT-03.7", "SAT-03.8", "SAT-03.9"],
  },
  ...
  "CFG-01": {
    ...
    sourceControls: ["CFG-01", "CFG-01.1"],
  },
  ...
  "CFG-04": {
    statement:
      "ACME enforces software usage restrictions to comply with contract agreements and copyright law, including defined parameters for open source software use and restrictions on unsupported browsers and email clients.",
    requirements: [
    ...
    sourceControls: ["CFG-04", "CFG-04.1", "CFG-04.2"],
  },

  "CFG-05": {
    statement:
      "ACME restricts non-privileged users from installing unauthorized software, alerting on detected unauthorized installations and limiting install privileges to privileged users or services.",
    requirements: [
    ...
    sourceControls: ["CFG-05", "CFG-05.1", "CFG-05.2"],
  },

  "CFG-08": {
    statement:
      "ACME configures its technology assets, applications, and services to restrict access to sensitive and regulated data, automatically logging every collection, creation, update, deletion, or archival action taken against that data.",
    requirements: [
    ...
    sourceControls: ["CFG-08", "CFG-08.1"],
  },

  "CRY-01": {
    statement:
      "ACME implements cryptographic protections using known public standards and trusted technologies — securing data in transit and as an alternative to physical safeguards, managing export-control compliance, concealing communication patterns where warranted, and maintaining a current inventory of deployed cipher suites and protocols.",
    requirements: [
    ...
    sourceControls: ["CRY-01", "CRY-01.1", "CRY-01.2", "CRY-01.3", "CRY-01.4", "CRY-01.5"],
  },
  ...
  "CRY-05": {
    ...
    sourceControls: ["CRY-05", "CRY-05.1", "CRY-05.2", "CRY-05.3"],
  },

  "CRY-08": {
    statement:
      "ACME operates a secure Public Key Infrastructure — either internally or through a reputable PKI service provider — with resiliency mechanisms ensuring data remains available even if cryptographic keys are lost.",
    requirements: [
    ...
    sourceControls: ["CRY-08", "CRY-08.1"],
  },
  ...
  "CRY-09": {
    ...
    sourceControls: ["CRY-09", "CRY-09.1", "CRY-09.2", "CRY-09.3", "CRY-09.4", "CRY-09.5", "CRY-09.6", "CRY-09.7"],
  },

  "IAO-01": {
    statement:
      "ACME implements formal security, compliance, and resilience assessment and authorization controls, with clearly defined assessment boundaries covering the people, processes, and technology that affect the confidentiality, integrity, availability, and safety of in-scope systems.",
    requirements: [
    ...
    sourceControls: ["IAO-01", "IAO-01.1"],
  },

  "IAO-02": {
    statement:
      "ACME formally assesses the security, compliance, and resilience controls of its technology assets through an Information Assurance Program, using independent assessors, specialized assessment types where warranted, and reciprocity for credible external assessments, culminating in a Security Assessment Report for each engagement.",
    requirements: [
    ...
    sourceControls: ["IAO-02", "IAO-02.1", "IAO-02.2", "IAO-02.3", "IAO-02.4"],
  },

  "IAO-03": {
    statement:
      "ACME maintains authoritative System Security Plan documentation reflecting the current state and history of applied controls for in-scope systems, coordinated with affected stakeholders in advance of assessment activity and extended to protect sensitive data handled in support of contracts.",
    requirements: [
    ...
    sourceControls: ["IAO-03", "IAO-03.1", "IAO-03.2"],
  },
  ...
  "IAO-05": {
    ...
    sourceControls: ["IAO-05", "IAO-05.1"],
  },
  ...
  "TPM-01": {
    ...
    sourceControls: ["TPM-01", "TPM-01.1"],
  },

  "TPM-03": {
    statement:
      "ACME evaluates and remediates security risks in its technology supply chain, using tailored acquisition strategies, safeguards that limit harm from adversaries targeting the supply chain, defined processes to address identified weaknesses, and a spare parts strategy to ensure critical components remain available.",
    requirements: [
    ...
    sourceControls: ["TPM-03", "TPM-03.1", "TPM-03.2", "TPM-03.3", "TPM-03.4"],
  },
  ...
  "TPM-04": {
    ...
    sourceControls: ["TPM-04", "TPM-04.1", "TPM-04.2", "TPM-04.3", "TPM-04.4"],
  },

  "TPM-05": {
    statement:
      "ACME requires contracts with third parties to reflect its security, compliance, and resilience needs — covering breach notification, flow-down obligations to subcontractors, unique authentication per customer, a documented RASCI matrix for control ownership, break clauses for non-performance, and both first- and third-party attestations of compliance.",
    requirements: [
    ...
    sourceControls: ["TPM-05", "TPM-05.1", "TPM-05.2", "TPM-05.3", "TPM-05.4", "TPM-05.5", "TPM-05.6", "TPM-05.7", "TPM-05.8"],
  },
  ...
  "END-01": {
    ...
    sourceControls: ["END-01", "END-01.1"],
  },

  "END-03": {
    statement:
      "ACME prevents software installation without explicit privileged authorization, alerting on new software detection and enforcing documented, approved access restrictions for any change to technology assets.",
    requirements: [
    ...
    sourceControls: ["END-03", "END-03.1", "END-03.2"],
  },
  ...
  "END-04": {
    ...
    sourceControls: ["END-04", "END-04.1", "END-04.2", "END-04.3", "END-04.4", "END-04.5", "END-04.6", "END-04.7"],
  },
  ...
  "END-06": {
    ...
    sourceControls: ["END-06", "END-06.1", "END-06.2", "END-06.3", "END-06.4", "END-06.5", "END-06.6", "END-06.7", "END-06.8"],
  },
  ...
  "END-08": {
    ...
    sourceControls: ["END-08", "END-08.1", "END-08.2"],
  },

  "END-16": {
    statement:
      "ACME restricts security functions to authorized individuals under least-privilege principles, with host-based isolation separating security functions from other software on the endpoint.",
    requirements: [
    ...
    sourceControls: ["END-16", "END-16.1"],
  },
  ...
  "RSK-01": {
    ...
    sourceControls: ["RSK-01", "RSK-01.1", "RSK-01.2", "RSK-01.3", "RSK-01.4", "RSK-01.5"],
  },

  "RSK-02": {
    statement:
      "ACME categorizes its technology assets, applications, services, and data according to applicable laws, regulations, and contractual obligations, documenting the categorization rationale and requiring asset-owner review and approval, with impact levels prioritized to prevent disruption.",
    requirements: [
    ...
    sourceControls: ["RSK-02", "RSK-02.1"],
  },

  "RSK-03": {
    statement:
      "ACME identifies and documents internal and external risks in a current, maintained risk catalog covering its business operations and technologies in use.",
    requirements: [
    ...
    sourceControls: ["RSK-03", "RSK-03.1"],
  },
  ...
  "RSK-04": {
    ...
    sourceControls: ["RSK-04", "RSK-04.1", "RSK-04.2", "RSK-04.3", "RSK-04.4"],
  },
  ...
  "RSK-06": {
    ...
    sourceControls: ["RSK-06", "RSK-06.1", "RSK-06.2", "RSK-06.3", "RSK-06.4"],
  },

  "RSK-09": {
    statement:
      "ACME maintains a Supply Chain Risk Management plan covering the development, acquisition, maintenance, and disposal of technology assets — including periodic supply chain risk assessments and consideration of AI/AAT-specific supply chain risks such as third-party software and data.",
    requirements: [
    ...
    sourceControls: ["RSK-09", "RSK-09.1", "RSK-09.2"],
  },
  ...
  "GOV-01": {
    ...
    sourceControls: ["GOV-01", "GOV-01.1", "GOV-01.2", "GOV-01.3"],
  },

  "GOV-02": {
    statement:
      "ACME establishes, maintains, and disseminates the policies, standards, and procedures needed for secure, compliant, and resilient operations, prohibiting exceptions unless formally risk-assessed, approved, and recorded.",
    requirements: [
    ...
    sourceControls: ["GOV-02", "GOV-02.1"],
  },

  "GOV-04": {
    statement:
      "ACME assigns qualified individuals the mission and resources to centrally manage its Security, Compliance & Resilience Program, enforced through a clear accountability structure and an authoritative chain of command that removes ambiguity in risk ownership.",
    requirements: [
    ...
    sourceControls: ["GOV-04", "GOV-04.1", "GOV-04.2"],
  },
  ...
  "GOV-05": {
    ...
    sourceControls: ["GOV-05", "GOV-05.1", "GOV-05.2"],
  },

  "GOV-15": {
    statement:
      "ACME requires data and process owners to select, implement, assess, authorize, and continuously monitor the security, compliance, and resilience controls for every technology asset, application, and service under their control.",
    requirements: [
    ...
    sourceControls: ["GOV-15", "GOV-15.1", "GOV-15.2", "GOV-15.3", "GOV-15.4", "GOV-15.5"],
  },

  "GOV-16": {
    statement:
      "ACME defines the criteria used to determine when an incident, risk, or threat rises to the level of material, ensuring consistent and defensible materiality determinations across the organization.",
    requirements: [
    ...
    sourceControls: ["GOV-16", "GOV-16.1", "GOV-16.2"],
  },
  ...
  "VPM-01": {
    ...
    sourceControls: ["VPM-01", "VPM-01.1"],
  },

  "VPM-03": {
    statement:
      "ACME ranks newly discovered vulnerabilities using reputable external sources and analyzes the likelihood and impact of known vulnerabilities being exploited by applicable threats.",
    requirements: [
    ...
    sourceControls: ["VPM-03", "VPM-03.1"],
  },

  "VPM-04": {
    statement:
      "ACME continuously addresses new threats and vulnerabilities, keeping stable software versions installed, correcting flaws affecting personal data, and deliberately deferring patches only when the disadvantages of applying them outweigh the benefits.",
    requirements: [
    ...
    sourceControls: ["VPM-04", "VPM-04.1", "VPM-04.2", "VPM-04.3"],
  },
  ...
  "AST-02": {
    ...
    sourceControls: ["AST-02", "AST-02.1", "AST-02.2", "AST-02.3", "AST-02.4", "AST-02.5", "AST-02.6", "AST-02.7", "AST-02.8", "AST-02.9", "AST-02.10", "AST-02.11"],
  },

  "AST-03": {
    statement:
      "ACME assigns, tracks, and manages asset ownership at the team, individual, or organizational level, capturing accountable owners and full provenance for every technology asset.",
    requirements: [
    ...
    sourceControls: ["AST-03", "AST-03.1", "AST-03.2"],
  },

  "AST-04": {
    statement:
      "ACME maintains current network architecture diagrams documenting sensitive data flows, asset scope categorization, and graphically represented control-applicability boundaries, with a maintained inventory of assets in scope for compliance obligations.",
    requirements: [
    ...
    sourceControls: ["AST-04", "AST-04.1", "AST-04.2", "AST-04.3"],
  },
  ...
  "AST-05": {
    ...
    sourceControls: ["AST-05", "AST-05.1"],
  },

  "AST-06": {
    statement:
      "ACME requires enhanced protection for unattended technology assets against tampering and unauthorized access, including user education on physically securing mobile devices when traveling.",
    requirements: [
    ...
    sourceControls: ["AST-06", "AST-06.1"],
  },

  "AST-15": {
    statement:
      "ACME assesses the logical and physical integrity of critical technology assets to detect evidence of tampering, including regular physical and logical inspection of those assets.",
    requirements: [
    ...
    sourceControls: ["AST-15", "AST-15.1"],
  },
  ...
  "IRO-02": {
    ...
    sourceControls: ["IRO-02", "IRO-02.1", "IRO-02.2", "IRO-02.3", "IRO-02.4", "IRO-02.5", "IRO-02.6"],
  },
  ...
  "IRO-04": {
    ...
    sourceControls: ["IRO-04", "IRO-04.1", "IRO-04.2", "IRO-04.3"],
  },

  "IRO-05": {
    statement:
      "ACME trains personnel in their incident response roles and responsibilities, using simulated events and automated training environments to build effective crisis response skills.",
    requirements: [
    ...
    sourceControls: ["IRO-05", "IRO-05.1", "IRO-05.2"],
  },
  ...
  "IRO-08": {
    statement:
      "ACME performs digital forensics and maintains chain-of-custody integrity per applicable law and industry-recognized practice, using licensed forensic investigators for evidentiary analysis.",
    requirements: [
    ...
    sourceControls: ["IRO-08", "IRO-08.1"],
  },
  ...
  "IRO-09": {
    ...
    sourceControls: ["IRO-09", "IRO-09.1", "IRO-09.2", "IRO-09.3", "IRO-09.4"],
  },
  ...
  "IRO-10": {
    ...
    sourceControls: ["IRO-10", "IRO-10.1", "IRO-10.2", "IRO-10.3", "IRO-10.4", "IRO-10.5"],
  },

  "IRO-11": {
    statement:
      "ACME provides users advice and assistance for handling and reporting actual or potential incidents, supported by automation and cooperative relationships with external service providers.",
    requirements: [
    ...
    sourceControls: ["IRO-11", "IRO-11.1", "IRO-11.2"],
  },

  "IRO-12": {
    statement:
      "ACME formally assigns responsibility for responding to sensitive/regulated data spills, trains personnel on spill response, ensures continuity of operations for affected personnel during remediation, and safeguards personnel who are inadvertently exposed to data outside their access authorization.",
    requirements: [
    ...
    sourceControls: ["IRO-12", "IRO-12.1", "IRO-12.2", "IRO-12.3", "IRO-12.4"],
  },
  ...
  "MON-01": {
    ...
    sourceControls: ["MON-01", "MON-01.1", "MON-01.2", "MON-01.3", "MON-01.4", "MON-01.5", "MON-01.6", "MON-01.7", "MON-01.8", "MON-01.9", "MON-01.10", "MON-01.11", "MON-01.12", "MON-01.13", "MON-01.14", "MON-01.15", "MON-01.16", "MON-01.17"],
  },
  ...
  "MON-02": {
    ...
    sourceControls: ["MON-02", "MON-02.1", "MON-02.2", "MON-02.3", "MON-02.4", "MON-02.5", "MON-02.6", "MON-02.7", "MON-02.8", "MON-02.9"],
  },
  ...
  "MON-03": {
    ...
    sourceControls: ["MON-03", "MON-03.1", "MON-03.2", "MON-03.3", "MON-03.4", "MON-03.5", "MON-03.6", "MON-03.7"],
  },

  "MON-05": {
    statement:
      "ACME alerts appropriate personnel around the clock when event log processing fails or storage capacity nears its limit, and takes action to remedy the disruption.",
    requirements: [
    ...
    sourceControls: ["MON-05", "MON-05.1", "MON-05.2"],
  },

  "MON-06": {
    statement:
      "ACME generates event log reports to detect and assess anomalous activity, auditing query parameters against personal data and using trend analysis to determine whether monitoring controls need to evolve.",
    requirements: [
    ...
    sourceControls: ["MON-06", "MON-06.1", "MON-06.2"],
  },

  "MON-07": {
    statement:
      "ACME configures its systems to generate event log timestamps from an authoritative time source, with internal system clocks synchronized accordingly.",
    requirements: [
    ...
    sourceControls: ["MON-07", "MON-07.1"],
  },
  ...
  "MON-08": {
    ...
    sourceControls: ["MON-08", "MON-08.1", "MON-08.2", "MON-08.3", "MON-08.4"],
  },

  "MON-11": {
    statement:
      "ACME monitors for unauthorized exfiltration or disclosure of non-public information, analyzing network traffic for covert exfiltration, detecting unauthorized network services, and alerting on indicators of compromise.",
    requirements: [
    ...
    sourceControls: ["MON-11", "MON-11.1", "MON-11.2", "MON-11.3"],
  },

  "MON-16": {
    statement:
      "ACME uses User & Entity Behavior Analytics and User Activity Monitoring to detect anomalous behavior indicating account compromise, covering insider threats, third-party personnel, unauthorized activities, and privileged account/group permission changes.",
    requirements: [
    ...
    sourceControls: ["MON-16", "MON-16.1", "MON-16.2", "MON-16.3", "MON-16.4"],
  },
  ...
  "TDA-01": {
    ...
    sourceControls: ["TDA-01", "TDA-01.1", "TDA-01.2", "TDA-01.3", "TDA-01.4"],
  },

  "TDA-02": {
    statement:
      "ACME designs and produces technology assets to meet risk-based Minimum Viable Product security and resiliency criteria — identifying ports/protocols/services early, using validated IA-enabled products, applying secure-by-default configurations, minimizing attack surface, delivering ongoing security updates, and disclosing vulnerabilities responsibly to stakeholders.",
    requirements: [
    ...
    sourceControls: ["TDA-02", "TDA-02.1", "TDA-02.2", "TDA-02.3", "TDA-02.4", "TDA-02.5", "TDA-02.6", "TDA-02.7", "TDA-02.8", "TDA-02.9", "TDA-02.10", "TDA-02.11", "TDA-02.12", "TDA-02.13", "TDA-02.14"],
  },

  "TDA-04": {
    statement:
      "ACME obtains, protects, and distributes administrator documentation describing secure configuration, effective use of security features, and known vulnerabilities — including functional control descriptions and a Software Bill of Materials for every technology asset.",
    requirements: [
    ...
    sourceControls: ["TDA-04", "TDA-04.1", "TDA-04.2"],
  },

  "TDA-05": {
    statement:
      "ACME requires developers to produce a design specification and security architecture consistent with ACME's enterprise architecture, describing control allocation and how security functions work together — with physical diagnostic and test interfaces secured and monitored against misuse.",
    requirements: [
    ...
    sourceControls: ["TDA-05", "TDA-05.1", "TDA-05.2"],
  },
  ...
  "TDA-06": {
    ...
    sourceControls: ["TDA-06", "TDA-06.1", "TDA-06.2", "TDA-06.3", "TDA-06.4", "TDA-06.5", "TDA-06.6"],
  },

  "TDA-08": {
    statement:
      "ACME separates development, testing, and production environments to prevent unauthorized access or change to production, and purges test/development data and accounts before migration to production.",
    requirements: [
    ...
    sourceControls: ["TDA-08", "TDA-08.1"],
  },
  ...
  "TDA-09": {
    ...
    sourceControls: ["TDA-09", "TDA-09.1", "TDA-09.2", "TDA-09.3", "TDA-09.4", "TDA-09.5", "TDA-09.6", "TDA-09.7"],
  },
  ...
  "TDA-10": {
    ...
    sourceControls: ["TDA-10", "TDA-10.1"],
  },

  "TDA-14": {
    statement:
      "ACME requires developers and integrators to perform configuration management across system design, development, implementation, and operation, with integrity verification enabled for both software/firmware and hardware components.",
    requirements: [
    ...
    sourceControls: ["TDA-14", "TDA-14.1", "TDA-14.2"],
  },
  ...
  "TDA-20": {
    ...
    sourceControls: ["TDA-20", "TDA-20.1", "TDA-20.2", "TDA-20.3", "TDA-20.4"],
  },
  ...
  "PES-01": {
    ...
    sourceControls: ["PES-01", "PES-01.1", "PES-01.2"],
  },

  "PES-02": {
    statement:
      "ACME maintains a current list of personnel authorized for physical facility access, granted by role, with dual authorization required for highly sensitive areas.",
    requirements: [
    ...
    sourceControls: ["PES-02", "PES-02.1", "PES-02.2"],
  },
  ...
  "PES-03": {
    ...
    sourceControls: ["PES-03", "PES-03.1", "PES-03.2", "PES-03.3", "PES-03.4"],
  },

  "PES-04": {
    statement:
      "ACME identifies systems and environments requiring limited physical access, restricting secure areas to authorized personnel, inspecting personnel and effects to prevent exfiltration, and securely storing undelivered packages under monitored, access-controlled conditions.",
    requirements: [
    ...
    sourceControls: ["PES-04", "PES-04.1", "PES-04.2", "PES-04.3"],
  },

  "PES-05": {
    statement:
      "ACME monitors, detects, and responds to physical security incidents using intrusion alarms and surveillance equipment, with enhanced monitoring for critical systems and sensitive data.",
    requirements: [
    ...
    sourceControls: ["PES-05", "PES-05.1", "PES-05.2"],
  },

  "PES-06": {
    statement:
      "ACME identifies, authorizes, and monitors visitors before granting facility access — distinguishing them from personnel, requiring photo ID, restricting unescorted access, minimizing personal data collected, and ensuring badges are surrendered or automatically deactivated, with automated review of visitor records.",
    requirements: [
    ...
    sourceControls: ["PES-06", "PES-06.1", "PES-06.2", "PES-06.3", "PES-06.4", "PES-06.5", "PES-06.6"],
  },

  "PES-07": {
    statement:
      "ACME protects facility power and utilities through automatic voltage control, accessible emergency shutoff, backup power, emergency lighting, water damage protection with automated leak detection, and redundant, physically separated power cabling.",
    requirements: [
    ...
    sourceControls: ["PES-07", "PES-07.1", "PES-07.2", "PES-07.3", "PES-07.4", "PES-07.5", "PES-07.6", "PES-07.7"],
  },

  "PES-08": {
    statement:
      "ACME maintains fire suppression and detection systems supported by an independent energy source, automatically notifying personnel and emergency responders, with automatic suppression for critical systems in unstaffed facilities.",
    requirements: [
    ...
    sourceControls: ["PES-08", "PES-08.1", "PES-08.2", "PES-08.3"],
  },

  "PES-09": {
    statement:
      "ACME maintains and monitors facility temperature and humidity, alerting on changes that could harm personnel or equipment.",
    requirements: [
    ...
    sourceControls: ["PES-09", "PES-09.1"],
  },

  "PES-12": {
    statement:
      "ACME sites system components to minimize damage from physical and environmental hazards and unauthorized access, protecting cabling from interception or damage and restricting access to output devices like printers.",
    requirements: [
    ...
    sourceControls: ["PES-12", "PES-12.1", "PES-12.2"],
  },
  ...
  "HRS-01": {
    ...
    sourceControls: ["HRS-01", "HRS-01.1"],
  },

  "HRS-02": {
    statement:
      "ACME assigns risk designations to positions and establishes screening criteria accordingly, ensuring personnel with elevated privileges or access to sensitive data are cleared and trained, with enhanced monitoring during onboarding probation.",
    requirements: [
    ...
    sourceControls: ["HRS-02", "HRS-02.1", "HRS-02.2"],
  },

  "HRS-03": {
    statement:
      "ACME defines cybersecurity roles and responsibilities for all personnel, communicating expectations to maintain a secure working environment and ensuring security-related positions are staffed by qualified individuals.",
    requirements: [
    ...
    sourceControls: ["HRS-03", "HRS-03.1", "HRS-03.2"],
  },
  ...
  "HRS-04": {
    ...
    sourceControls: ["HRS-04", "HRS-04.1", "HRS-04.2", "HRS-04.3", "HRS-04.4"],
  },

  "HRS-05": {
    statement:
      "ACME requires employees and contractors to apply cybersecurity and data protection principles daily, defining acceptable use rules — including social media, technology, mobile device, and dress-code restrictions — with recurring policy familiarization and acknowledgement.",
    requirements: [
    ...
    sourceControls: ["HRS-05", "HRS-05.1", "HRS-05.2", "HRS-05.3", "HRS-05.4", "HRS-05.5", "HRS-05.6", "HRS-05.7"],
  },

  "HRS-06": {
    statement:
      "ACME requires internal and third-party users to sign appropriate access agreements before being granted access, including confidentiality agreements and notification of post-employment data protection obligations.",
    requirements: [
    ...
    sourceControls: ["HRS-06", "HRS-06.1", "HRS-06.2"],
  },

  "HRS-07": {
    statement:
      "ACME sanctions personnel who fail to comply with security policies, conducting misconduct investigations, periodically updating disciplinary processes, and proactively restricting access when an individual under investigation may face termination.",
    requirements: [
    ...
    sourceControls: ["HRS-07", "HRS-07.1", "HRS-07.2", "HRS-07.3"],
  },
  ...
  "HRS-09": {
    ...
    sourceControls: ["HRS-09", "HRS-09.1", "HRS-09.2", "HRS-09.3", "HRS-09.4"],
  },
  ...
  "HRS-12": {
    ...
    sourceControls: ["HRS-12", "HRS-12.1"],
  },

  "HRS-13": {
    statement:
      "ACME evaluates the critical security, compliance, and resilience skills needed to support its mission, identifying and remediating gaps, designating vital staff, and building redundancy and succession plans for those key roles.",
    requirements: [
    ...
    sourceControls: ["HRS-13", "HRS-13.1", "HRS-13.2", "HRS-13.3", "HRS-13.4"],
  },
  ...
  "BCD-01": {
    ...
    sourceControls: ["BCD-01", "BCD-01.1", "BCD-01.2", "BCD-01.3", "BCD-01.4", "BCD-01.5", "BCD-01.6", "BCD-01.7"],
  },

  "BCD-02": {
    statement:
      "ACME identifies and documents the critical technology assets, applications, services, and data supporting essential missions, ensuring those missions resume or continue within defined recovery objectives, with periodic security review of sensitive data storage locations.",
    requirements: [
    ...
    sourceControls: ["BCD-02", "BCD-02.1", "BCD-02.2", "BCD-02.3", "BCD-02.4"],
  },

  "BCD-03": {
    statement:
      "ACME trains contingency personnel and stakeholders in their roles and responsibilities using simulated events and automated environments to build effective crisis response.",
    requirements: [
    ...
    sourceControls: ["BCD-03", "BCD-03.1", "BCD-03.2"],
  },
  ...
  "BCD-04": {
    ...
    sourceControls: ["BCD-04", "BCD-04.1", "BCD-04.2"],
  },

  "BCD-06": {
    statement:
      "ACME updates contingency plans to reflect changes in people, processes, technology, data, and facilities, identifying components that could impact plan execution and keeping stakeholders informed of changes.",
    requirements: [
    ...
    sourceControls: ["BCD-06", "BCD-06.1", "BCD-06.2"],
  },
  ...
  "BCD-08": {
    ...
    sourceControls: ["BCD-08", "BCD-08.1", "BCD-08.2"],
  },

  "BCD-09": {
    statement:
      "ACME maintains an alternate processing site with security measures equivalent to the primary site — separated to avoid shared threats, prepared for use as a primary site, prioritized for service to meet RTOs, and planned for scenarios where return to the primary site isn't possible.",
    requirements: [
      ...
      { title: "Primary Site Separation", detail: "The alternate site is separated from the primary site to reduce shared threat exposure." },
      { title: "Accessibility Mitigation", detail: "Accessibility problems to the alternate site during disruption are identified and mitigated." },
    ...
    sourceControls: ["BCD-09", "BCD-09.1", "BCD-09.2", "BCD-09.3", "BCD-09.4", "BCD-09.5"],
  },

  "BCD-10": {
    statement:
      "ACME reduces single points of failure in telecommunications by contracting priority-of-service provisions, using alternate providers separated from primary providers, requiring providers to maintain their own contingency plans, and maintaining alternate command-and-control communications channels.",
    requirements: [
    ...
    sourceControls: ["BCD-10", "BCD-10.1", "BCD-10.2", "BCD-10.3", "BCD-10.4"],
  },
  ...
  "BCD-11": {
    ...
    sourceControls: ["BCD-11", "BCD-11.1", "BCD-11.2", "BCD-11.3", "BCD-11.4", "BCD-11.5", "BCD-11.6", "BCD-11.7", "BCD-11.8", "BCD-11.9", "BCD-11.10"],
  },
  ...
  "BCD-13": {
    statement:
      "ACME protects backup and restoration hardware and software, verifying the integrity of backups and restoration assets before they are used to restore operations.",
    requirements: [
    ...
    sourceControls: ["BCD-13", "BCD-13.1"],
  },
  ...
  "PRI-01": {
    ...
    sourceControls: ["PRI-01", "PRI-01.1", "PRI-01.2", "PRI-01.3", "PRI-01.4", "PRI-01.5", "PRI-01.6", "PRI-01.7", "PRI-01.8", "PRI-01.9", "PRI-01.10", "PRI-01.11"],
  },
  ...
  "PRI-02": {
    ...
    sourceControls: ["PRI-02", "PRI-02.1", "PRI-02.2", "PRI-02.3", "PRI-02.4", "PRI-02.5", "PRI-02.6", "PRI-02.7", "PRI-02.8", "PRI-02.9", "PRI-02.10", "PRI-02.11", "PRI-02.12", "PRI-02.13", "PRI-02.14"],
  },

  "PRI-03": {
    statement:
      "ACME obtains meaningful, revocable consent before processing personal data — offering tailored and just-in-time consent, honoring opt-out signals like Global Privacy Control, prohibiting sale of a minor's data, preventing discrimination against those who exercise privacy rights, and requiring parental consent for minors.",
    requirements: [
    ...
    sourceControls: ["PRI-03", "PRI-03.1", "PRI-03.2", "PRI-03.3", "PRI-03.4", "PRI-03.5", "PRI-03.6", "PRI-03.7", "PRI-03.8", "PRI-03.9", "PRI-03.10", "PRI-03.11", "PRI-03.12", "PRI-03.13"],
  },
  ...
  "PRI-04": {
    ...
    sourceControls: ["PRI-04", "PRI-04.1", "PRI-04.2", "PRI-04.3", "PRI-04.4", "PRI-04.5", "PRI-04.6", "PRI-04.7"],
  },
  ...
  "PRI-06": {
    ...
    sourceControls: ["PRI-06", "PRI-06.1", "PRI-06.2", "PRI-06.3", "PRI-06.4", "PRI-06.5", "PRI-06.6", "PRI-06.7", "PRI-06.8"],
  },

  "PRI-07": {
    statement:
      "ACME discloses personal data to third parties only for stated purposes and with consent, contractually binding contractors and service providers to data privacy obligations, clearly defining joint processing roles, and rejecting unauthenticated, harassing, or fraudulent disclosure requests.",
    requirements: [
    ...
    sourceControls: ["PRI-07", "PRI-07.1", "PRI-07.2", "PRI-07.3", "PRI-07.4", "PRI-07.5"],
  },

  "PRI-10": {
    statement:
      "ACME manages the quality, objectivity, and integrity of sensitive/regulated data across its lifecycle, using automation to evaluate data quality and evaluating analytical processes for potential bias.",
    requirements: [
    ...
    sourceControls: ["PRI-10", "PRI-10.1", "PRI-10.2"],
  },

  "PRI-12": {
    statement:
      "ACME identifies and records the processes and frequency used to update personal data, enabling data subjects to update their own PD directly.",
    requirements: [
    ...
    sourceControls: ["PRI-12", "PRI-12.1"],
  },

  "PRI-14": {
    statement:
      "ACME documents its personal data processing activities in sufficient detail to demonstrate regulatory conformity, providing subjects an accounting of disclosures and notifying them of applicable legal disclosure requests.",
    requirements: [
    ...
    sourceControls: ["PRI-14", "PRI-14.1", "PRI-14.2"],
  },

  "PRI-17": {
    statement:
      "ACME crafts data subject communications to be concise and understandable, prominently linking to its privacy notice, disclosing financial incentive terms, and tracking and, where required, publicly reporting metrics on data subject requests.",
    requirements: [
    ...
    sourceControls: ["PRI-17", "PRI-17.1", "PRI-17.2", "PRI-17.3", "PRI-17.4", "PRI-17.5"],
  },
  ...
  "NET-01": {
    ...
    sourceControls: ["NET-01", "NET-01.1"],
  },

  "NET-02": {
    statement:
      "ACME implements layered network security functions that minimize inter-layer dependency — protecting against denial-of-service attacks, securing guest networks, and mitigating cross-domain data transfer risk.",
    requirements: [
      { title: "Layered Security Functions", detail: "Security functions are implemented as a layered structure minimizing inter-layer dependency." },
    ...
    sourceControls: ["NET-02", "NET-02.1", "NET-02.2", "NET-02.3"],
  },
  ...
  "NET-04": {
    statement:
      "ACME enforces data flow through Access Control Lists that deny traffic by default, apply security attributes and metadata to flow decisions, inspect content even within encrypted data, restrict embedded data types, use automated policy decision points, and apply cross-domain authentication and content filtering for information transferred between security domains.",
    requirements: [
    ...
    sourceControls: ["NET-04", "NET-04.1", "NET-04.2", "NET-04.3", "NET-04.4", "NET-04.5", "NET-04.6", "NET-04.7", "NET-04.8", "NET-04.9", "NET-04.10", "NET-04.11", "NET-04.12", "NET-04.13", "NET-04.14"],
  },

  "NET-05": {
    statement:
      "ACME authorizes system interconnections through documented Interconnection Security Agreements covering interface characteristics, security requirements, and data nature — prohibiting direct external connections to sensitive systems without boundary protection, and documenting all internal system connections.",
    requirements: [
    ...
    sourceControls: ["NET-05", "NET-05.1", "NET-05.2"],
  },
  ...
  "NET-06": {
    ...
    sourceControls: ["NET-06", "NET-06.1", "NET-06.2", "NET-06.3", "NET-06.4", "NET-06.5", "NET-06.6", "NET-06.7"],
  },

  "NET-08": {
    statement:
      "ACME deploys network and wireless intrusion detection/prevention systems, monitors DMZ segments separating trusted and untrusted networks, and automatically contains compromised hosts and resources.",
    requirements: [
    ...
    sourceControls: ["NET-08", "NET-08.1", "NET-08.2", "NET-08.3", "NET-08.4"],
  },

  "NET-09": {
    statement:
      "ACME protects the authenticity and integrity of communication sessions, invalidating session identifiers at logout and generating unique identifiers for every session.",
    requirements: [
    ...
    sourceControls: ["NET-09", "NET-09.1", "NET-09.2"],
  },

  "NET-12": {
    statement:
      "ACME uses strong cryptography to protect sensitive data transmitted over open, public networks — monitoring wireless links for unauthorized connections and prohibiting unprotected sensitive data transmission via end-user messaging tools.",
    requirements: [
    ...
    sourceControls: ["NET-12", "NET-12.1", "NET-12.2"],
  },
  ...
  "NET-14": {
    ...
    sourceControls: ["NET-14", "NET-14.1", "NET-14.2", "NET-14.3", "NET-14.4", "NET-14.5", "NET-14.6", "NET-14.7", "NET-14.8"],
  },

  "NET-15": {
    statement:
      "ACME controls authorized wireless usage and monitors for unauthorized access — authenticating and encrypting Wi-Fi connections, disabling unnecessary embedded wireless capability, restricting user configuration, confining communications to controlled boundaries, and detecting rogue access points.",
    requirements: [
    ...
    sourceControls: ["NET-15", "NET-15.1", "NET-15.2", "NET-15.3", "NET-15.4", "NET-15.5"],
  },
  ...
  "NET-18": {
    ...
    sourceControls: ["NET-18", "NET-18.1", "NET-18.2", "NET-18.3", "NET-18.4", "NET-18.5", "NET-18.6", "NET-18.7", "NET-18.8", "NET-18.9"],
  },
  ...
  "DCH-01": {
    ...
    sourceControls: ["DCH-01", "DCH-01.1", "DCH-01.2", "DCH-01.3", "DCH-01.4"],
  },
  ...
  "DCH-02": {
    ...
    sourceControls: ["DCH-02", "DCH-02.1"],
  },

  "DCH-03": {
    statement:
      "ACME restricts digital and non-digital media access to authorized individuals, limiting sensitive data disclosure to those with a need to know, masking displayed/printed data, and automatically validating protection attributes before releasing information externally.",
    requirements: [
    ...
    sourceControls: ["DCH-03", "DCH-03.1", "DCH-03.2", "DCH-03.3"],
  },

  "DCH-04": {
    statement:
      "ACME marks media per data protection requirements to alert personnel to distribution limitations and handling requirements, using automated marking to support Data Loss Prevention tooling.",
    requirements: [
    ...
    sourceControls: ["DCH-04", "DCH-04.1"],
  },

  "DCH-06": {
    statement:
      "ACME physically secures and controls digital and non-digital media in controlled areas — maintaining annual inventories, scanning unstructured data sources for sensitive data, rendering stored sensitive data unreadable, and prohibiting storage of authentication data after authorization.",
    requirements: [
    ...
    sourceControls: ["DCH-06", "DCH-06.1", "DCH-06.2", "DCH-06.3", "DCH-06.4", "DCH-06.5"],
  },

  "DCH-07": {
    statement:
      "ACME protects and controls digital and non-digital media during transport outside controlled areas, identifying custodians throughout transit and encrypting data stored on digital media.",
    requirements: [
    ...
    sourceControls: ["DCH-07", "DCH-07.1", "DCH-07.2"],
  },
  ...
  "DCH-09": {
    ...
    sourceControls: ["DCH-09", "DCH-09.1", "DCH-09.2", "DCH-09.3", "DCH-09.4", "DCH-09.5"],
  },

  "DCH-10": {
    statement:
      "ACME restricts the types of digital media permitted on systems, limiting sensitive data use and distribution and prohibiting ownerless portable storage devices.",
    requirements: [
    ...
    sourceControls: ["DCH-10", "DCH-10.1", "DCH-10.2"],
  },
  ...
  "DCH-13": {
    ...
    sourceControls: ["DCH-13", "DCH-13.1", "DCH-13.2", "DCH-13.3", "DCH-13.4"],
  },

  "DCH-14": {
    statement:
      "ACME guides users' information-sharing decisions to ensure data is appropriately protected — enforcing search/retrieval restrictions, verifying transfer authorizations, and mapping sensitive data sharing relationships via ACLs and ISAs.",
    requirements: [
    ...
    sourceControls: ["DCH-14", "DCH-14.1", "DCH-14.2", "DCH-14.3"],
  },
  ...
  "DCH-18": {
    ...
    sourceControls: ["DCH-18", "DCH-18.1", "DCH-18.2", "DCH-18.3"],
  },

  "DCH-22": {
    statement:
      "ACME checks for redundant, obsolete, toxic, or trivial data to maintain accuracy and relevance across the information lifecycle, correcting inaccurate personal data, tagging sensitive data for automated tracking, and collecting personal data directly from individuals where possible.",
    requirements: [
    ...
    sourceControls: ["DCH-22", "DCH-22.1", "DCH-22.2", "DCH-22.3"],
  },

  "DCH-23": {
    statement:
      "ACME anonymizes personal data by removing it from datasets at collection, archival, or release where not needed, masking or replacing direct identifiers, applying statistical disclosure controls and differential privacy noise, validating de-identification algorithms, testing against motivated-intruder re-identification, and using non-descriptive code names for sensitive assets.",
    requirements: [
    ...
    sourceControls: ["DCH-23", "DCH-23.1", "DCH-23.2", "DCH-23.3", "DCH-23.4", "DCH-23.5", "DCH-23.6", "DCH-23.7", "DCH-23.8", "DCH-23.9"],
  },

  "DCH-24": {
    statement:
      "ACME identifies and documents where information and its supporting system components reside, using automated tools to ensure adequate controls are in place based on data classification.",
    requirements: [
    ...
    sourceControls: ["DCH-24", "DCH-24.1"],
  },
  ...
  "IAC-01": {
    ...
    sourceControls: ["IAC-01", "IAC-01.1", "IAC-01.2", "IAC-01.3"],
  },

  "IAC-02": {
    statement:
      "ACME uniquely identifies and centrally authenticates organizational users — requiring individual authentication behind any group authenticator, using replay-resistant methods, accepting PIV credentials, and enabling out-of-band authentication where warranted.",
    requirements: [
    ...
    sourceControls: ["IAC-02", "IAC-02.1", "IAC-02.2", "IAC-02.3", "IAC-02.4"],
  },

  "IAC-03": {
    statement:
      "ACME uniquely identifies and authenticates third-party users through FICAM-compliant credentials and profiles, accepting external PIV credentials, disassociating user attributes from credential relationships, and restricting external authenticators to NIST-compliant options.",
    requirements: [
    ...
    sourceControls: ["IAC-03", "IAC-03.1", "IAC-03.2", "IAC-03.3", "IAC-03.4", "IAC-03.5"],
  },
  ...
  "IAC-04": {
    ...
    sourceControls: ["IAC-04", "IAC-04.1", "IAC-04.2"],
  },

  "IAC-05": {
    statement:
      "ACME identifies and authenticates third-party technology assets, applications, and services, requiring external providers to share current, accurate user information and prohibiting privileged access by non-organizational users.",
    requirements: [
    ...
    sourceControls: ["IAC-05", "IAC-05.1", "IAC-05.2"],
  },
  ...
  "IAC-06": {
    ...
    sourceControls: ["IAC-06", "IAC-06.1", "IAC-06.2", "IAC-06.3", "IAC-06.4", "IAC-06.5"],
  },
  ...
  "IAC-07": {
    ...
    sourceControls: ["IAC-07", "IAC-07.1", "IAC-07.2"],
  },

  "IAC-09": {
    statement:
      "ACME governs username and system identifier naming standards, dynamically managing them, distinguishing contractors and third parties, coordinating cross-organization identifiers, uniquely marking privileged accounts, and generating pairwise pseudonymous identifiers to limit tracking.",
    requirements: [
    ...
    sourceControls: ["IAC-09", "IAC-09.1", "IAC-09.2", "IAC-09.3", "IAC-09.4", "IAC-09.5", "IAC-09.6"],
  },
  ...
  "IAC-10": {
    ...
    sourceControls: ["IAC-10", "IAC-10.1", "IAC-10.2", "IAC-10.3", "IAC-10.4", "IAC-10.5", "IAC-10.6", "IAC-10.7", "IAC-10.8", "IAC-10.9", "IAC-10.10", "IAC-10.11", "IAC-10.12", "IAC-10.13", "IAC-10.14"],
  },

  "IAC-12": {
    statement:
      "ACME ensures cryptographic modules meet applicable security strength requirements, using Hardware Security Modules to protect the authenticators they rely on.",
    requirements: [
    ...
    sourceControls: ["IAC-12", "IAC-12.1"],
  },

  "IAC-13": {
    statement:
      "ACME allows alternative authentication methods under specific circumstances — providing transparent Single Sign-On, federated cross-organization credentials, and continuous re-authentication throughout entity interactions.",
    requirements: [
    ...
    sourceControls: ["IAC-13", "IAC-13.1", "IAC-13.2", "IAC-13.3"],
  },

  "IAC-15": {
    statement:
      "ACME proactively governs all account types — automating directory-services account management, removing temporary/emergency accounts on schedule, disabling inactive accounts, auditing account lifecycle actions, restricting shared accounts, immediately disabling high-risk individuals, reviewing orphaned accounts, and enforcing usage conditions.",
    requirements: [
    ...
    sourceControls: ["IAC-15", "IAC-15.1", "IAC-15.2", "IAC-15.3", "IAC-15.4", "IAC-15.5", "IAC-15.6", "IAC-15.7", "IAC-15.8", "IAC-15.9"],
  },
  ...
  "IAC-20": {
    ...
    sourceControls: ["IAC-20", "IAC-20.1", "IAC-20.2", "IAC-20.3", "IAC-20.4", "IAC-20.5", "IAC-20.6", "IAC-20.7"],
  },
  ...
  "IAC-21": {
    ...
    sourceControls: ["IAC-21", "IAC-21.1", "IAC-21.2", "IAC-21.3", "IAC-21.4", "IAC-21.5", "IAC-21.6", "IAC-21.7"],
  },

  "IAC-24": {
    statement:
      "ACME locks sessions after a defined inactivity period or on user request, requiring re-authentication to resume, and conceals previously visible screen content during the lock.",
    requirements: [
    ...
    sourceControls: ["IAC-24", "IAC-24.1"],
  },

  "IAC-25": {
    statement:
      "ACME automatically logs out users, locally and remotely, at session end or after a defined inactivity period, providing an explicit logout capability and confirmation message.",
    requirements: [
    ...
    sourceControls: ["IAC-25", "IAC-25.1"],
  },

  "IAC-28": {
    statement:
      "ACME verifies user identity before issuing authenticators or modifying access — requiring management approval for account changes, evidence of identity presented and validated per defined methods, in-person verification before a registration authority, and out-of-band address confirmation.",
    requirements: [
    ...
    sourceControls: ["IAC-28", "IAC-28.1", "IAC-28.2", "IAC-28.3", "IAC-28.4", "IAC-28.5"],
  },
};
