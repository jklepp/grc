import { Cloud, Users, FileText, CreditCard } from "lucide-react";
...
export function totalTB(s) { return s.liveDataTB + s.backupDataTB; }
...
export const TOTAL_LIVE_TB = VOLUME_SOURCES.reduce((a, s) => a + s.liveDataTB, 0);
export const TOTAL_BACKUP_TB = VOLUME_SOURCES.reduce((a, s) => a + s.backupDataTB, 0);
...
export const CUSTOMER_ACCOUNT_COUNT = DATA_SOURCES.find((s) => s.name === "AWS").entityCount;
