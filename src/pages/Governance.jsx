...
// System Security Plan top-level pages into one, switched by an in-page tab
// bar instead of five sidebar entries. Each page's own content is untouched
// — this is purely a shell around them.
const TABS = [
  ...
  { id: "ssp", label: "System Security Plan", icon: ClipboardCheck, Page: SystemSecurityPlan },
];
...
// app-level navigator, which no longer has a page for them.
const INTERNAL_TABS = {
