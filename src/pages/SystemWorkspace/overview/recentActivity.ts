...
import type {
  IdentityPosture, IncidentResponsePosture, ResiliencePosture,
  SecurityTestingPosture, VendorPosture,
} from "../types";
...
export function recentActivityForSystem({ identity, resilience, secTests, ir, vendors }: RecentActivityInput): RecentActivityEvent[] {
