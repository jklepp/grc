...
import type { DataFlowDiagram, DiagramNode } from "../utils/flowDiagramLayout";
...
const FlowDiagramSVG = forwardRef<SVGSVGElement, FlowDiagramProps>(function FlowDiagramSVG({ diagram, selectedKey, onSelectNode }, ref) {
  return (
    <svg
      ref={ref}
...
export function FlowDiagramLegend({ kinds }: { kinds?: readonly EdgeStyleKind[] }) {
  const list = kinds || EDGE_KINDS;
  return (
