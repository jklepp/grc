...
const GRAPH_EXPLORER_ITEM: NavigationItem = { id: "graph-explorer", label: "Graph Explorer (Beta)", icon: Share2 };

interface SidebarProps {
  expanded: boolean;
  onToggle: () => void;
  active: NavigationPageId;
  onSelect: (id: NavigationPageId) => void;
  mode: ThemeMode;
  onToggleTheme: () => void;
}

export default function Sidebar({ expanded, onToggle, active, onSelect, mode, onToggleTheme }: SidebarProps) {
  return (
    <div
