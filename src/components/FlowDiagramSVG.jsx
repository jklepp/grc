...
function AssetNode({ node }) {
  ...
  const bandColor = { green: LIGHT.green, amber: LIGHT.amber, red: LIGHT.red, na: LIGHT.na }[asset.assuranceBand?.color] || LIGHT.na;
  return (
    <g>
      ...
      <text x={node.x + node.w - 10} y={node.y + 20} fontSize={9} fontWeight="bold" fill={bandColor} textAnchor="end" fontFamily="Courier New, monospace">{asset.overallAssurance}%</text>
